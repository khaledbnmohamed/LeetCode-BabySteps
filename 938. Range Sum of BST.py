...
#new solution by traversing the tree


# Runtime: 276 ms, faster than 21.91% of Python3 online submissions for Range Sum of BST.
# Memory Usage: 22.1 MB, less than 33.01% of Python3 online submissions for Range Sum of BST.
